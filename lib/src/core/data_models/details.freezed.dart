...
mixin _$Details {
  ...
  ContentfulImage? get image => throw _privateConstructorUsedError;
...
abstract class $DetailsCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? size, ContentfulImage? image});
...
class _$DetailsCopyWithImpl<$Res, $Val extends Details>
  ...
  $ContentfulImageCopyWith<$Res>? get image {
    ...
    return $ContentfulImageCopyWith<$Res>(_value.image!, (value) {
...
class _$DetailsImpl implements _Details {
  const _$DetailsImpl({this.size, this.image});
...
abstract class _Details implements Details {
  const factory _Details({final int? size, final ContentfulImage? image}) =
      _$DetailsImpl;
